...
const projects: ProjectModel[] = [
    ...
    },
    {
        ...
        title: "Bank Thing",
        description:
            "A financial analytics platform that leverages open banking APIs to connect to your bank accounts. Features spending insights and an AI assistant that analyzes your financial patterns to provide personalised recommendations for improving your banking habits.",
        image: "./images/bank-thing.png",
        link: "https://bank-thing.gowtham.io",
        github: "https://github.com/gowth6m/bank-thing",
        stack: [
            "NestJS",
            "Redis Pub/Sub",
            "BullMQ",
